...
public class UserController {
	...
	/**
	 * @Title: userCenter @Description: 用户中心 @param: @return @return: String @throws
	 */
	...
	/**
	 * @Title: login @Description: 跳转到登录页面 @param: @return @return: String @throws
	 */
	@GetMapping("/login")
	...
	/**
	 * @Title: signOut @Description: 退出登录 @param: @param response @param: @param
	...
	/**
	 * @Title: register @Description: 跳转到注册页面 @param: @return @return:
	 * String @throws
	 */
	...
	/**
	 * @Title: register @Description: 用户注册 @param: @param
	 * user @param: @return @return: JsonResult @throws
	 */
	...
	/**
	 * @Title: article @Description: 文章管理 @param: @return @return: String @throws
	 */
